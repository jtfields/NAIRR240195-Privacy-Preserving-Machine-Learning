...
<p>We utilize OpenMined’s PySyft as a core component. The purpose of this project is to develop privacy-preserving machine learning models to improve student retention prediction in higher education, while strictly adhering to FERPA (Family Educational Rights and Privacy Act) compliance. This framework enables secure, privacy-respecting collaboration across institutions without compromising student data privacy.</p>
